    ...
    <div style={{ background: B, color: T1, fontFamily: SANS, overflowX: 'hidden' }}>
      ...
      <section style={{ padding: '0 40px 80px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 1, background: LINE, borderRadius: 12, overflow: 'hidden' }}>
          {([
            { name: 'Instagram', status: 'Live', icon: <div style={{ width:28, height:28, borderRadius:6, background:'linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="5"/><circle cx="17.5" cy="6.5" r="1.5" fill="white" stroke="none"/></svg></div> },
            { name: 'LinkedIn', status: 'Live', icon: <div style={{ width:28, height:28, borderRadius:6, background:'#0A66C2', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg></div> },
            { name: 'X / Twitter', status: 'Live', icon: <div style={{ width:28, height:28, borderRadius:6, background:'#000', border:'1px solid rgba(255,255,255,0.15)', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="14" height="14" viewBox="0 0 24 24" fill="white"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L2.25 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg></div> },
            { name: 'TikTok', status: 'Live', icon: <div style={{ width:28, height:28, borderRadius:6, background:'#010101', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="15" height="15" viewBox="0 0 24 24" fill="white"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.73a4.85 4.85 0 0 1-1.01-.04z"/></svg></div> },
            { name: 'Notion', status: 'Soon', icon: <div style={{ width:28, height:28, borderRadius:6, background:'#fff', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="16" height="16" viewBox="0 0 24 24" fill="#000"><path d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L17.86 1.968c-.42-.326-.981-.7-2.055-.607L3.01 2.295c-.466.046-.56.28-.374.466zm.793 3.08v13.904c0 .747.373 1.027 1.214.98l14.523-.84c.841-.046.935-.56.935-1.167V6.354c0-.606-.233-.933-.748-.887l-15.177.887c-.56.047-.747.327-.747.933zm14.337.745c.093.42 0 .84-.42.887l-.7.14v10.264c-.608.327-1.168.514-1.635.514-.748 0-.935-.234-1.495-.933l-4.577-7.186v6.952L12.21 19s0 .84-1.168.84l-3.222.186c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.822 9.76c-.094-.42.14-1.026.793-1.073l3.456-.233 4.764 7.279v-6.44l-1.215-.14c-.093-.514.28-.887.747-.933z"/></svg></div> },
            { name: 'Slack', status: 'Soon', icon: <div style={{ width:28, height:28, borderRadius:6, background:'#fff', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="16" height="16" viewBox="0 0 24 24"><path d="M14.5 10c-.83 0-1.5-.67-1.5-1.5v-5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5z" fill="#E01E5A"/><path d="M20.5 10H19V8.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" fill="#E01E5A"/><path d="M9.5 14c.83 0 1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5S8 21.33 8 20.5v-5c0-.83.67-1.5 1.5-1.5z" fill="#2EB67D"/><path d="M3.5 14H5v1.5c0 .83-.67 1.5-1.5 1.5S2 16.33 2 15.5 2.67 14 3.5 14z" fill="#2EB67D"/><path d="M10 9.5c0-.83.67-1.5 1.5-1.5h5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5h-5c-.83 0-1.5-.67-1.5-1.5z" fill="#ECB22E"/><path d="M10 3.5C10 2.67 10.67 2 11.5 2S13 2.67 13 3.5V5h-1.5C10.67 5 10 4.33 10 3.5z" fill="#ECB22E"/><path d="M14 14.5c0 .83-.67 1.5-1.5 1.5h-5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5h5c.83 0 1.5.67 1.5 1.5z" fill="#36C5F0"/><path d="M14 20.5c0 .83-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5V19h1.5c.83 0 1.5.67 1.5 1.5z" fill="#36C5F0"/></svg></div> },
            { name: 'HubSpot', status: 'Soon', icon: <div style={{ width:28, height:28, borderRadius:6, background:'#FF7A59', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M20.316 11.246l-3.196-1.566V7.684a2.03 2.03 0 0 0 1.13-1.82V5.82a2.03 2.03 0 0 0-2.03-2.03h-.052a2.03 2.03 0 0 0-2.03 2.03v.044c0 .793.46 1.482 1.13 1.82v1.996l-3.12-1.528a1.2 1.2 0 0 0-1.11.042L3.9 11.246a1.2 1.2 0 0 0 0 2.086l7.14 3.5a1.2 1.2 0 0 0 1.048 0l8.228-4.028a1.2 1.2 0 0 0 0-2.558z"/></svg></div> },
            { name: 'Google Drive', status: 'Soon', icon: <div style={{ width:28, height:28, borderRadius:6, background:'#fff', display:'flex', alignItems:'center', justifyContent:'center' }}><svg width="16" height="14" viewBox="0 0 87 78"><path d="M55.7 30L43.5 9 31.3 30z" fill="#FBBC05"/><path d="M87 69L74.8 48H12.2L0 69z" fill="#4285F4"/><path d="M31.3 30L0 69l12.2-21L43.5 9z" fill="#34A853"/><path d="M55.7 30l31.3 39H74.8L43.5 9z" fill="#EA4335"/></svg></div> },
        ...
        <div style={{ marginTop: 16, fontSize: 13, color: 'rgba(255,255,255,0.25)', fontFamily: SANS, textAlign: 'center', letterSpacing: '0.01em' }}>
          + Zapier, Make.com, Asana, Google Analytics, and 20+ more coming
        </div>
      </section>
