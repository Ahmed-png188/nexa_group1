    ...
    <div style={{ background: B, color: T1, fontFamily: SANS, overflowX: 'hidden' }}>
      ...
      <section style={{ padding: '0 40px 80px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 1, background: LINE, borderRadius: 12, overflow: 'hidden' }}>
          {([
            { name: 'Instagram', status: 'Live', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><rect x="2" y="2" width="20" height="20" rx="5" stroke="#E1306C" strokeWidth="1.5"/><circle cx="12" cy="12" r="5" stroke="#E1306C" strokeWidth="1.5"/><circle cx="17.5" cy="6.5" r="1.2" fill="#E1306C"/></svg> },
            { name: 'LinkedIn', status: 'Live', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="#0A66C2" style={{flexShrink:0}}><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg> },
            { name: 'X / Twitter', status: 'Live', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="white" style={{flexShrink:0}}><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.737-8.835L2.25 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> },
            { name: 'TikTok', status: 'Live', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="white" style={{flexShrink:0}}><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.73a4.85 4.85 0 0 1-1.01-.04z"/></svg> },
            { name: 'Make.com', status: 'Live', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><circle cx="12" cy="12" r="9" stroke="#A855F7" strokeWidth="1.5"/><path d="M8 12h8M12 8v8" stroke="#A855F7" strokeWidth="1.5" strokeLinecap="round"/></svg> },
            { name: 'Zapier', status: 'Live', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><path d="M13.5 2L3 13h7.5L9 22l12-11h-7.5L13.5 2z" stroke="#FF4A00" strokeWidth="1.5" strokeLinejoin="round"/></svg> },
            { name: 'Slack', status: 'Live', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><path d="M14.5 10c-.83 0-1.5-.67-1.5-1.5v-5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5z" fill="#E01E5A"/><path d="M20.5 10H19V8.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" fill="#E01E5A"/><path d="M9.5 14c.83 0 1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5S8 21.33 8 20.5v-5c0-.83.67-1.5 1.5-1.5z" fill="#2EB67D"/><path d="M3.5 14H5v1.5c0 .83-.67 1.5-1.5 1.5S2 16.33 2 15.5 2.67 14 3.5 14z" fill="#2EB67D"/><path d="M10 9.5c0-.83.67-1.5 1.5-1.5h5c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5h-5c-.83 0-1.5-.67-1.5-1.5z" fill="#ECB22E"/><path d="M10 3.5C10 2.67 10.67 2 11.5 2S13 2.67 13 3.5V5h-1.5C10.67 5 10 4.33 10 3.5z" fill="#ECB22E"/><path d="M14 14.5c0 .83-.67 1.5-1.5 1.5h-5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5h5c.83 0 1.5.67 1.5 1.5z" fill="#36C5F0"/><path d="M14 20.5c0 .83-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5V19h1.5c.83 0 1.5.67 1.5 1.5z" fill="#36C5F0"/></svg> },
            { name: 'HubSpot', status: 'Soon', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><circle cx="17" cy="7" r="3" stroke="#FF7A59" strokeWidth="1.5"/><circle cx="7" cy="17" r="3" stroke="#FF7A59" strokeWidth="1.5"/><circle cx="17" cy="17" r="3" stroke="#FF7A59" strokeWidth="1.5"/><path d="M10 17h4M17 10v4M9.5 14.5l5-5" stroke="#FF7A59" strokeWidth="1.5" strokeLinecap="round"/></svg> },
            { name: 'Notion', status: 'Soon', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="white" style={{flexShrink:0}}><path d="M4.459 4.208c.746.606 1.026.56 2.428.466l13.215-.793c.28 0 .047-.28-.046-.326L17.86 1.968c-.42-.326-.981-.7-2.055-.607L3.01 2.295c-.466.046-.56.28-.374.466zm.793 3.08v13.904c0 .747.373 1.027 1.214.98l14.523-.84c.841-.046.935-.56.935-1.167V6.354c0-.606-.233-.933-.748-.887l-15.177.887c-.56.047-.747.327-.747.933zm14.337.745c.093.42 0 .84-.42.887l-.7.14v10.264c-.608.327-1.168.514-1.635.514-.748 0-.935-.234-1.495-.933l-4.577-7.186v6.952L12.21 19s0 .84-1.168.84l-3.222.186c-.093-.186 0-.653.327-.746l.84-.233V9.854L7.822 9.76c-.094-.42.14-1.026.793-1.073l3.456-.233 4.764 7.279v-6.44l-1.215-.14c-.093-.514.28-.887.747-.933z"/></svg> },
            { name: 'Google Drive', status: 'Soon', icon: <svg width="24" height="24" viewBox="0 0 87 78" style={{flexShrink:0}}><path d="M55.7 30L43.5 9 31.3 30z" fill="#FBBC05"/><path d="M87 69L74.8 48H12.2L0 69z" fill="#4285F4"/><path d="M31.3 30L0 69l12.2-21L43.5 9z" fill="#34A853"/><path d="M55.7 30l31.3 39H74.8L43.5 9z" fill="#EA4335"/></svg> },
            { name: 'Google Analytics', status: 'Soon', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><rect x="3" y="12" width="4" height="9" rx="1" fill="#F9AB00"/><rect x="10" y="7" width="4" height="14" rx="1" fill="#E37400"/><rect x="17" y="3" width="4" height="18" rx="1" fill="#E37400"/></svg> },
            { name: 'Asana', status: 'Soon', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><circle cx="12" cy="5.5" r="3.5" fill="#F06A6A"/><circle cx="5" cy="15.5" r="3.5" fill="#F06A6A"/><circle cx="19" cy="15.5" r="3.5" fill="#F06A6A"/></svg> },
            { name: 'Calendly', status: 'Soon', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><rect x="3" y="4" width="18" height="17" rx="3" stroke="#006BFF" strokeWidth="1.5"/><path d="M3 9h18" stroke="#006BFF" strokeWidth="1.5"/><path d="M8 2v4M16 2v4" stroke="#006BFF" strokeWidth="1.5" strokeLinecap="round"/></svg> },
            { name: 'WhatsApp', status: 'Soon', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" style={{flexShrink:0}}><path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2 22l4.95-1.418A9.954 9.954 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2z" stroke="#25D366" strokeWidth="1.5" fill="none"/><path d="M8.5 9.5c.5 1 1.5 3 3.5 4s3-1 3-1-.5-1.5-1-1.5S13 11.5 13 11.5s-1-1.5-2-3c-.5-.75-1.5-.5-2 0s-.5 1.5 0 1" fill="#25D366"/></svg> },
          ] as {name:string;status:string;icon:React.ReactNode}[]).map(({ name, status, icon }) => (
            <div key={name} style={{ background: '#070707', padding: '20px 24px', display: 'flex', alignItems: 'center', gap: 14 }}>
              <div style={{ width:44, height:44, borderRadius:10, background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.08)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                {icon}
              </div>
              <div>
