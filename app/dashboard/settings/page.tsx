...
function Field({ label, hint, children }: any) {
  return (
    <div style={{ marginBottom:20 }}>
      <div style={{ fontFamily:"'Geist', sans-serif", fontSize:12, fontWeight:500, color:'rgba(255,255,255,0.55)', marginBottom:7, letterSpacing:'-0.01em' }}>{label}</div>
      {children}
  ...
  return (
    <input
      ...
      style={{
        ...
        fontFamily:"'Geist', sans-serif", fontSize:14, outline:'none',
    ...
    <>
      <textarea
        ...
        style={{
          ...
          fontFamily:"'Geist', sans-serif", outline:'none', resize:'vertical',
  ...
  return (
    <button onClick={onClick} disabled={saving||disabled}
      style={{
        ...
        fontSize:13, fontWeight:700, fontFamily:"'Geist', sans-serif", letterSpacing:'-0.02em',
...
function SettingsInner() {
  ...
  if (loading) return (
    <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'calc(100vh - var(--topbar-h))', flexDirection:'column', gap:16, background:'#000' }}>
      ...
      <div style={{ fontSize:11, color:'var(--t4)', fontFamily:"'Geist', sans-serif", letterSpacing:'0.06em', textTransform:'uppercase' as const, fontWeight:500 }}>Loading</div>
    </div>
  )
        ...
        <div style={{ borderRight:'1px solid rgba(255,255,255,0.06)', display:'flex', flexDirection:'column', padding:'20px 14px', overflow:'hidden' }}>
          ...
          <div style={{ padding:'16px', borderRadius:14, background:'rgba(255,255,255,0.025)', border:'1px solid rgba(255,255,255,0.07)', marginBottom:20 }}>
            <div style={{ display:'flex', alignItems:'center', gap:12 }}>
              <div style={{ width:42, height:42, borderRadius:13, background:'linear-gradient(135deg,#4D9FFF,#A78BFA)', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:"'Geist', sans-serif", fontSize:17, fontWeight:800, color:'#fff', flexShrink:0, boxShadow:'0 4px 12px rgba(77,159,255,0.3)' }}>
                {initial}
              </div>
            ...
            {NAV.map(n => {
              ...
              return (
                <button key={n.id} onClick={() => { setTab(n.id); setSaved(false) }}
                  style={{ display:'flex', alignItems:'center', gap:10, padding:'10px 12px', borderRadius:11, background:on?'rgba(77,159,255,0.08)':'transparent', border:`1px solid ${on?'rgba(77,159,255,0.18)':'transparent'}`, color:on?'#4D9FFF':'rgba(255,255,255,0.45)', cursor:'pointer', fontFamily:"'Geist', sans-serif", fontSize:13, fontWeight:500, transition:'all 0.15s', textAlign:'left', width:'100%' }}
          ...
          <button onClick={signOut}
            style={{ display:'flex', alignItems:'center', gap:9, padding:'10px 12px', borderRadius:11, background:'transparent', border:'1px solid transparent', color:'rgba(255,87,87,0.65)', cursor:'pointer', fontSize:13, fontFamily:"'Geist', sans-serif", transition:'all 0.15s', width:'100%' }}
        ...
        <div style={{ overflowY:'auto', padding:'32px 40px 60px' }}>
          ...
          {tab === 'profile' && (
            <div style={{ maxWidth:520, animation:'pageUp 0.35s ease both' }}>
              <div style={{ marginBottom:28 }}>
                <h2 style={{ fontFamily:"'Geist', sans-serif", fontSize:20, fontWeight:800, letterSpacing:'-0.04em', color:'rgba(255,255,255,0.92)', marginBottom:5 }}>Profile</h2>
          ...
          {tab === 'workspace' && (
            <div style={{ maxWidth:560, animation:'pageUp 0.35s ease both' }}>
              <div style={{ marginBottom:28 }}>
                <h2 style={{ fontFamily:"'Geist', sans-serif", fontSize:20, fontWeight:800, letterSpacing:'-0.04em', color:'rgba(255,255,255,0.92)', marginBottom:5 }}>Workspace</h2>
          ...
          {tab === 'billing' && (
            <div style={{ animation:'pageUp 0.35s ease both' }}>
              <div style={{ marginBottom:28 }}>
                <h2 style={{ fontFamily:"'Geist', sans-serif", fontSize:20, fontWeight:800, letterSpacing:'-0.04em', color:'rgba(255,255,255,0.92)', marginBottom:5 }}>Billing</h2>
              ...
              <div style={{ padding:'20px 24px', background:'rgba(255,255,255,0.025)', border:'1px solid rgba(255,255,255,0.08)', borderRadius:16, marginBottom:28, display:'flex', alignItems:'center', gap:20 }}>
                <div>
                  ...
                  <div style={{ fontFamily:"'Geist', sans-serif", fontSize:22, fontWeight:800, letterSpacing:'-0.04em', color:planColor, textTransform:'capitalize' }}>{currentPlan}</div>
                ...
                <div>
                  ...
                  <div className="nexa-num" style={{ fontFamily:"'Geist Mono', monospace", fontWeight:300, fontSize:22 }}>
              ...
              {ws?.stripe_subscription_id && (
                <div style={{ marginBottom:24 }}>
                  <button onClick={openPortal}
                    style={{ display:'flex', alignItems:'center', gap:8, padding:'10px 20px', fontSize:13, fontWeight:700, fontFamily:"'Geist', sans-serif", background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:11, color:'rgba(255,255,255,0.7)', cursor:'pointer', transition:'all 0.18s', letterSpacing:'-0.01em' }}
                  ...
                  return (
                    <div key={plan.id} className="nexa-card"
                      ...
                      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:12 }}>
                        <span style={{ fontFamily:"'Geist', sans-serif", fontWeight:700, fontSize:16, letterSpacing:'-0.03em', color:isCurrent?plan.color:'rgba(255,255,255,0.82)' }}>{plan.name}</span>
                        {isCurrent && (
                      ...
                      <div style={{ marginBottom:4 }}>
                        <span style={{ fontFamily:"'Geist Mono', monospace", fontWeight:300, fontSize:22, letterSpacing:'-0.04em', color:'rgba(255,255,255,0.92)' }}>
                      ...
                      {!isCurrent && plan.price > 0 && (
                        <button onClick={() => { if(plan.id !== currentPlan) checkout(plan.id) }}
                          style={{ width:'100%', padding:'10px', fontSize:12, fontWeight:700, background:plan.color, color:'#000', border:'none', borderRadius:10, cursor:'pointer', fontFamily:"'Geist', sans-serif", transition:'all 0.15s', boxShadow:`0 4px 14px ${plan.color}35`, letterSpacing:'-0.01em' }}>
          ...
          {tab === 'leadpage' && (
            <div style={{ maxWidth:560, animation:'pageUp 0.35s ease both' }}>
              <div style={{ fontFamily:"'Geist', sans-serif", fontSize:18, fontWeight:800, color:'#fff', letterSpacing:'-0.03em', marginBottom:4 }}>Lead page</div>
              <div style={{ fontSize:13, color:'var(--t4)', fontFamily:"'Geist', sans-serif", marginBottom:24 }}>
                Your public page captures leads from your content 24/7
              </div>

              {/* Slug section */}
              <div style={{ marginBottom:24 }}>
                <div style={{ fontSize:11, fontWeight:600, letterSpacing:'0.08em', textTransform:'uppercase' as const, color:'var(--t4)', marginBottom:8, fontFamily:"'Geist', sans-serif" }}>Your lead page URL</div>
                <div style={{ display:'flex', gap:8, marginBottom:8 }}>
                  <div style={{ display:'flex', alignItems:'center', flex:1, background:'#0A0A0A', border:'1px solid rgba(255,255,255,0.1)', borderRadius:9, overflow:'hidden' }}>
                    <div style={{ padding:'10px 12px', fontSize:13, color:'rgba(255,255,255,0.3)', fontFamily:"'Geist Mono', monospace", fontWeight:300, borderRight:'1px solid rgba(255,255,255,0.07)', whiteSpace:'nowrap' as const, flexShrink:0 }}>nexaa.cc/</div>
                    <input
                      value={slug}
                      onChange={e => setSlug(e.target.value.toLowerCase().replace(/[^a-z0-9-]/g, '').slice(0, 30))}
                      placeholder="yourname"
                      style={{ flex:1, padding:'10px 12px', fontSize:13, background:'transparent', border:'none', color:'#fff', outline:'none', fontFamily:"'Geist', sans-serif" }}
                    />
                  </div>
                  <button
                    onClick={async () => {
                    ...
                    style={{ padding:'10px 16px', background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:9, fontSize:12, color:'var(--t3)', cursor:'pointer', fontFamily:"'Geist', sans-serif", whiteSpace:'nowrap' as const }}
                  >
                    Copy link
                  </button>
                  <button
                ...
                {slug && (
                  <div style={{ fontSize:11, color:'rgba(30,142,240,0.7)', fontFamily:"'Geist Mono', monospace", fontWeight:300 }}>
                    nexaa.cc/{slug}
                  </div>
                )}
              </div>
              ...
              {/* Custom question */}
              <div style={{ marginBottom:24 }}>
                <div style={{ fontSize:11, fontWeight:600, letterSpacing:'0.08em', textTransform:'uppercase' as const, color:'var(--t4)', marginBottom:8, fontFamily:"'Geist', sans-serif" }}>Custom question on your form</div>
                <input
                  value={customQ}
                  onChange={e => setCustomQ(e.target.value)}
                  placeholder="e.g. What's your biggest challenge right now?"
                  style={{ width:'100%', background:'#0A0A0A', border:'1px solid rgba(255,255,255,0.1)', borderRadius:9, padding:'10px 14px', fontSize:13, color:'#fff', fontFamily:"'Geist', sans-serif", outline:'none' }}
                />
              </div>

              {/* Auto-enrollment */}
              <div style={{ marginBottom:24 }}>
                <div style={{ fontSize:11, fontWeight:600, letterSpacing:'0.08em', textTransform:'uppercase' as const, color:'var(--t4)', marginBottom:8, fontFamily:"'Geist', sans-serif" }}>When someone submits the form...</div>
                <div style={{ display:'flex', flexDirection:'column' as const, gap:8 }}>
                  <label style={{ display:'flex', alignItems:'center', gap:10, cursor:'pointer' }}>
                    <input type="radio" checked={!leadAutoEnroll} onChange={() => setLeadAutoEnroll(false)} style={{ accentColor:'#1E8EF0' }} />
                    <span style={{ fontSize:13, color:'var(--t2)', fontFamily:"'Geist', sans-serif" }}>Just add to contacts</span>
                  </label>
                  <label style={{ display:'flex', alignItems:'center', gap:10, cursor:'pointer' }}>
                    <input type="radio" checked={leadAutoEnroll} onChange={() => setLeadAutoEnroll(true)} style={{ accentColor:'#1E8EF0' }} />
                    <span style={{ fontSize:13, color:'var(--t2)', fontFamily:"'Geist', sans-serif" }}>Auto-enroll in a sequence</span>
                  </label>
                </div>
                ...
                {leadAutoEnroll && (
                  <div style={{ marginTop:12 }}>
                    <select
                      ...
                      style={{ width:'100%', background:'#0A0A0A', border:'1px solid rgba(255,255,255,0.1)', borderRadius:9, padding:'10px 14px', fontSize:13, color:'#fff', fontFamily:"'Geist', sans-serif", outline:'none', cursor:'pointer' }}
                    >
              ...
              <div style={{ marginBottom:24, padding:'16px', background:'#0A0A0A', border:'1px solid rgba(255,255,255,0.07)', borderRadius:12 }}>
                <div style={{ fontFamily:"'Geist', sans-serif", fontSize:13, fontWeight:700, color:'#fff', marginBottom:4 }}>Kit (ConvertKit) sync</div>
                <div style={{ fontSize:12, color:'var(--t4)', marginBottom:12, fontFamily:"'Geist', sans-serif" }}>Import your existing subscribers as contacts</div>
                <div style={{ display:'flex', gap:8 }}>
                  <input
                    ...
                    type="password"
                    style={{ flex:1, background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.1)', borderRadius:8, padding:'9px 12px', fontSize:13, color:'#fff', fontFamily:"'Geist', sans-serif", outline:'none' }}
                  />
                  <button
                    onClick={async () => {
                    ...
                    style={{ padding:'9px 16px', background:'var(--blue)', border:'none', borderRadius:8, fontSize:12, fontFamily:"'Geist', sans-serif", fontWeight:700, color:'#fff', cursor:'pointer', whiteSpace:'nowrap' as const }}
                  >
                    Connect →
                  </button>
                </div>
              ...
              {/* Typeform */}
              <div style={{ marginBottom:24, padding:'16px', background:'#0A0A0A', border:'1px solid rgba(255,255,255,0.07)', borderRadius:12 }}>
                <div style={{ fontFamily:"'Geist', sans-serif", fontSize:13, fontWeight:700, color:'#fff', marginBottom:4 }}>Typeform webhook</div>
                <div style={{ fontSize:12, color:'var(--t4)', marginBottom:10, fontFamily:"'Geist', sans-serif" }}>Capture leads from your Typeform forms automatically</div>
                <div style={{ fontSize:11, color:'rgba(255,255,255,0.3)', marginBottom:8, fontFamily:"'Geist Mono', monospace", fontWeight:300, wordBreak:'break-all' as const, padding:'8px 10px', background:'rgba(255,255,255,0.03)', borderRadius:6 }}>
                  {ws?.id ? `https://nexaa.cc/api/integrations/typeform/webhook?workspace_id=${ws.id}` : 'Save your workspace first'}
                </div>
                <div style={{ fontSize:11, color:'var(--t4)', fontFamily:"'Geist', sans-serif" }}>
              ...
              <button
                ...
                style={{ padding:'11px 28px', background:'var(--blue)', border:'none', borderRadius:9, fontFamily:"'Geist', sans-serif", fontSize:13, fontWeight:700, color:'#fff', cursor:'pointer' }}
              >
                Save settings
              </button>
            </div>
          ...
          {tab === 'password' && (
            <div style={{ maxWidth:420, animation:'pageUp 0.35s ease both' }}>
              <div style={{ marginBottom:28 }}>
                <h2 style={{ fontFamily:"'Geist', sans-serif", fontSize:20, fontWeight:800, letterSpacing:'-0.04em', color:'rgba(255,255,255,0.92)', marginBottom:5 }}>Security</h2>
              ...
              <div style={{ marginTop:40, paddingTop:28, borderTop:'1px solid rgba(255,87,87,0.12)' }}>
                ...
                <button
                  ...
                  disabled={deleting}
                  style={{ display:'flex', alignItems:'center', gap:8, padding:'10px 20px', background:'rgba(255,87,87,0.08)', border:'1px solid rgba(255,87,87,0.22)', borderRadius:10, color:'rgba(255,87,87,0.85)', fontSize:13, fontWeight:600, cursor:deleting?'not-allowed':'pointer', fontFamily:"'Geist', sans-serif", transition:'all 0.15s', opacity:deleting?0.6:1 }}
