...
export default function InsightsPage() {
  ...
  return (
    <>
      <style>{`@keyframes insUp{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}@keyframes insSpin{to{transform:rotate(360deg)}}.itab:hover{background:rgba(255,255,255,0.05)!important;}.row:hover{background:rgba(255,255,255,0.04)!important;}`}</style>
