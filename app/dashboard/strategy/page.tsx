...
export default function StrategyPage() {
      ...
      <div style={{ backgroundImage:'url(/cyan-header.png)', backgroundSize:'cover', backgroundPosition:'center top', padding:'56px 0 48px', position:'relative' }}>
        <div style={{ maxWidth:'600px', margin:'0 auto', padding:'0 40px', textAlign:'center', position:'relative', zIndex:1 }}>
          <div style={{ display:'inline-flex', alignItems:'center', gap:'6px', padding:'5px 14px', background:'rgba(0,0,0,0.12)', border:'1px solid rgba(0,0,0,0.18)', borderRadius:'100px', marginBottom:'24px' }}>
            ...
            <span style={{ fontSize:'11px', color:'rgba(0,0,0,0.65)', fontWeight:600 }}>Strategy · Not generated yet</span>
          </div>
          <h1 style={{ fontSize:'48px', fontWeight:700, letterSpacing:'-0.04em', color:'#0A0A0A', lineHeight:1.05, marginBottom:'16px' }}>
            Your strategy<br/>is waiting.
          </h1>
          <p style={{ fontSize:'16px', color:'rgba(0,0,0,0.55)', lineHeight:1.7, marginBottom:'36px' }}>
          ...
          {!hasBrand && (
            <div style={{ marginBottom:'20px', padding:'10px 18px', background:'rgba(0,0,0,0.10)', border:'1px solid rgba(0,0,0,0.16)', borderRadius:'8px', display:'inline-flex', alignItems:'center', gap:'8px' }}>
              ...
              <span style={{ fontSize:'12px', color:'rgba(0,0,0,0.60)' }}>Works best after Brand Brain is trained.</span>
              <a href="/dashboard/brand" style={{ fontSize:'12px', fontWeight:600, color:'rgba(0,0,80,0.75)', textDecoration:'none', flexShrink:0 }}>Train Brand Brain →</a>
            </div>
          )}
  ...
  if (generating) return (
    <div style={{ display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', height:'calc(100vh - var(--topbar-h))', gap:'16px', textAlign:'center', padding:'40px', background:'#0C0C0C', fontFamily:F }}>
      ...
      <div style={{ fontSize:'20px', fontWeight:600, letterSpacing:'-0.03em', color:'rgba(255,255,255,0.88)', fontFamily:F }}>Building your strategy…</div>
      <div style={{ fontSize:'13px', color:'rgba(255,255,255,0.35)', lineHeight:1.7, maxWidth:'360px' }}>
  ...
  return (
    <div style={{ height:'calc(100vh - var(--topbar-h))', overflowY:'auto', background:'#0C0C0C', fontFamily:F }}>
      <style dangerouslySetInnerHTML={{ __html:`
        ...
        .angle-row:hover { background:rgba(255,255,255,0.04) !important; }
      `}}/>
      ...
      <div style={{ opacity:mounted?1:0, transition:'opacity 0.4s ease' }}>
        ...
        <div style={{ backgroundImage:'url(/cyan-header.png)', backgroundSize:'cover', backgroundPosition:'center top', padding:'40px 0 28px' }}>
          <div style={{ padding:'0 36px', display:'flex', alignItems:'flex-end', justifyContent:'space-between', gap:'20px' }}>
            <div>
              <h1 style={{ fontSize:'36px', fontWeight:700, letterSpacing:'-0.04em', color:'#0A0A0A', lineHeight:1, marginBottom:'8px' }}>Strategy</h1>
      ...
      <div style={{ padding:'28px 36px 0' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:'12px', marginBottom:'28px' }}>
          <StatCard icon={Ic.users} label="Audience insights" value={Object.keys(aud).length||'—'}/>
          <StatCard icon={Ic.star}  label="Content pillars"   value={pillars.length||'—'}/>
          <StatCard icon={Ic.bolt}  label="Winning angles"    value={angles.length||'—'}/>
          <StatCard icon={Ic.cal}   label="Days planned"      value={planDays.length||'—'}/>
        </div>
      </div>
      ...
      <div style={{ padding:'0 36px 48px' }}>
          ...
          <div className="s-in">
            ...
            {Object.keys(aud).length === 0 && (
              <div style={{ textAlign:'center', padding:'48px', color:'rgba(255,255,255,0.25)', fontSize:'13px', border:'1px dashed rgba(255,255,255,0.08)', borderRadius:'10px', fontFamily:F }}>
                No audience data. Regenerate your strategy.
              </div>
            )}
          </div>
        )}
        ...
        {tab === 'pillars' && (
          <div className="s-in">
            {pillars.length > 0 ? (
                  ...
                  return (
                    <div key={i} style={{ padding:'22px', background:'#141414', border:'1px solid rgba(255,255,255,0.10)', borderRadius:'10px', transition:'border-color 0.15s' }}
                      ...
                      <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom:'14px' }}>
                        <div style={{ width:32, height:32, borderRadius:'8px', background:'rgba(0,170,255,0.10)', border:'1px solid rgba(0,170,255,0.20)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'13px', fontWeight:700, color:'#00AAFF', flexShrink:0, fontFamily:MONO }}>
                          {i+1}
                        </div>
                        ...
                        <div style={{ display:'flex', flexDirection:'column', gap:'5px' }}>
                          {topics.slice(0,4).map((t: string, j: number) => (
                            <div key={j} style={{ display:'flex', alignItems:'flex-start', gap:'8px' }}>
                              ...
                              <span style={{ fontSize:'12px', color:'rgba(255,255,255,0.50)', fontFamily:F }}>{t}</span>
                            </div>
                          ))}
                        </div>
                      )}
              ...
              <div style={{ textAlign:'center', padding:'48px', color:'rgba(255,255,255,0.25)', fontSize:'13px', border:'1px dashed rgba(255,255,255,0.08)', borderRadius:'10px', fontFamily:F }}>
                No pillars yet. Regenerate your strategy.
              </div>
            )}
          </div>
        )}
        ...
        {tab === 'angles' && (
          <div className="s-in">
            {angles.length > 0 ? (
                  ...
                  return (
                    <div key={i} style={{ padding:'22px', background:'#141414', border:'1px solid rgba(255,255,255,0.10)', borderRadius:'10px', transition:'border-color 0.15s' }}
                      ...
                      <div style={{ display:'flex', alignItems:'center', gap:'12px', marginBottom: (hook||why) ? '16px' : '0' }}>
                        <div style={{ width:26, height:26, borderRadius:'7px', background:'rgba(255,255,255,0.06)', border:'1px solid rgba(255,255,255,0.12)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'11px', fontWeight:700, color:'rgba(255,255,255,0.50)', flexShrink:0, fontFamily:MONO }}>
                          {i+1}
                        </div>
                        <div style={{ fontSize:'14px', fontWeight:600, color:'#FFFFFF', letterSpacing:'-0.02em', lineHeight:1.4, fontFamily:F }}>{title}</div>
                      </div>
                      {hook && (
                        <div style={{ padding:'12px 14px', background:'rgba(0,170,255,0.04)', border:'1px solid rgba(0,170,255,0.12)', borderLeft:'3px solid rgba(0,170,255,0.40)', borderRadius:'0 8px 8px 0', marginBottom:'10px' }}>
                          <div style={{ fontSize:'9px', fontWeight:600, color:'rgba(0,170,255,0.80)', letterSpacing:'0.08em', textTransform:'uppercase', marginBottom:'5px', fontFamily:F }}>Hook</div>
              ...
              <div style={{ textAlign:'center', padding:'48px', color:'rgba(255,255,255,0.25)', fontSize:'13px', border:'1px dashed rgba(255,255,255,0.08)', borderRadius:'10px', fontFamily:F }}>
                No angles yet. Regenerate your strategy.
              </div>
            )}
          </div>
        )}
                  ...
                  {planDays.map((day: any, i: number) => {
                    ...
                    return (
                      <div key={i}
                        ...
                        style={{
                          padding:'10px 9px',
                          background: isOpen ? 'rgba(0,170,255,0.08)' : 'rgba(255,255,255,0.02)',
                          borderColor: isOpen ? 'rgba(0,170,255,0.30)' : 'rgba(255,255,255,0.08)',
                        ...
                        {plat && (
                          <div style={{ fontSize:'8px', fontWeight:700, color:'rgba(255,255,255,0.22)', textTransform:'uppercase', letterSpacing:'0.04em', marginBottom:'3px', fontFamily:F }}>
                            {plat.slice(0,3)}
                          </div>
                        )}
                        <div style={{ fontSize:'9px', color:'rgba(255,255,255,0.30)', lineHeight:1.45, overflow:'hidden', display:'-webkit-box', WebkitLineClamp:2, WebkitBoxOrient:'vertical' as const, fontFamily:F }}>
                          {theme}
                        </div>
                        {hovDay === num && !isOpen && (
                          <button
                    ...
                    <div style={{ padding:'24px 28px', background:'#141414', border:'1px solid rgba(0,170,255,0.20)', borderTop:'3px solid #00AAFF', borderRadius:'10px', animation:'sUp 0.2s ease both' }}>
                      <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'20px' }}>
                        <div>
                          <div style={{ fontSize:'11px', color:'rgba(255,255,255,0.30)', marginBottom:'4px', fontFamily:F }}>
                            {day.platform ? `${day.platform} · ` : ''}Week {Math.ceil(expanded/7)}
                          </div>
                      ...
                      <div style={{ display:'flex', gap:'8px' }}>
                        <button onClick={() => router.push(`/dashboard/studio?strategy_day=${expanded}&angle=${encodeURIComponent(day.angle||day.theme||'')}`)}
                          ...
                          Create in Studio <span style={{ display:'flex' }}>{Ic.arrow}</span>
                        </button>
        ...
        {tab === 'timing' && (
          <div className="s-in">
            {!timingData ? (
              <EmptyState icon={Ic.clock} title="Timing Engine" desc="Nexa reverse-engineers your audience's daily schedule and finds the exact moments they're most receptive to your content.">
                <button onClick={generateTiming} disabled={genTiming}
                  ...
                  {genTiming ? <><div className="nexa-spinner" style={{ width:13, height:13 }}/>Building…</> : <><span style={{ display:'flex' }}>{Ic.clock}</span>Map my posting times</>}
                </button>
              </EmptyState>
            ) : (
              <div style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
                {timingData.analysis && (
                  <div style={{ padding:'20px 24px', background:'#141414', border:'1px solid rgba(255,255,255,0.10)', borderRadius:'10px' }}>
                    <Label>Why these times work</Label>
                ...
                <div>
                  <button onClick={generateTiming} style={{ display:'flex', alignItems:'center', gap:'6px', padding:'7px 14px', fontSize:'12px', fontWeight:500, background:'transparent', border:'1px solid rgba(255,255,255,0.10)', color:'rgba(255,255,255,0.40)', borderRadius:'8px', cursor:'pointer', fontFamily:F, transition:'all 0.15s' }}
        ...
        {tab === 'competitors' && (
          <div className="s-in">
            {!compData ? (
              <EmptyState icon={Ic.target} title="Competitor Intelligence" desc="Nexa maps your competitive landscape — who owns what positioning, where the gaps are, and exactly how to differentiate so you own a space nobody else is talking to.">
                <div style={{ width:'100%', maxWidth:'480px', marginBottom:'16px', textAlign:'left' }}>
                  <div style={{ fontSize:'11px', fontWeight:500, color:'rgba(255,255,255,0.30)', marginBottom:'8px', fontFamily:F }}>
                    Who are your competitors? <span style={{ color:'rgba(255,255,255,0.18)' }}>(optional)</span>
                  </div>
                  <textarea
                    value={compInput}
                    ...
                    style={{ width:'100%', padding:'12px 14px', fontSize:'13px', fontFamily:F, background:'rgba(255,255,255,0.04)', border:'1px solid rgba(255,255,255,0.10)', borderRadius:'10px', color:'rgba(255,255,255,0.80)', outline:'none', resize:'vertical', lineHeight:1.65, transition:'border-color 0.15s', boxSizing:'border-box' as const }}
                ...
                <button onClick={generateComp} disabled={genComp}
                  ...
                  {genComp ? <><div className="nexa-spinner" style={{ width:13, height:13 }}/>Analyzing…</> : <><span style={{ display:'flex' }}>{Ic.target}</span>Run competitor analysis</>}
                </button>
              </EmptyState>
            ) : (
              <div style={{ display:'flex', flexDirection:'column', gap:'16px' }}>
                ...
                {compData.market_position && (
                  <div style={{ padding:'20px 24px', background:'#141414', border:'1px solid rgba(255,255,255,0.10)', borderRadius:'10px' }}>
                    <Label>Your Market Position</Label>
                ...
                {compData.differentiation_strategy?.positioning_statement && (
                  <div style={{ padding:'22px 26px', background:'#141414', border:'1px solid rgba(255,255,255,0.10)', borderLeft:'3px solid #00AAFF', borderRadius:'0 10px 10px 0' }}>
                    <Label>Your Positioning Statement</Label>
                    ...
                    <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'12px', marginTop:'10px' }}>
                      {compData.white_space.map((w: any, i: number) => (
                        <div key={i} className="comp-card"
                          style={{ padding:'18px', background:'#141414', border:'1px solid rgba(255,255,255,0.10)', borderRadius:'10px', transition:'all 0.15s' }}>
                ...
                {compData.winning_angles?.length > 0 && (
                  <div>
                    <Label>Winning Angles Competitors Miss</Label>
                ...
                {compData.competitors?.length > 0 && (
                  <div>
                    <Label>Competitor Breakdown</Label>
                    <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:'12px', marginTop:'10px' }}>
                      {compData.competitors.map((c: any, i: number) => (
                        <div key={i} style={{ padding:'18px', background:'#141414', border:'1px solid rgba(255,255,255,0.10)', borderRadius:'10px' }}>
                          <div style={{ fontSize:'14px', fontWeight:600, color:'rgba(255,255,255,0.85)', marginBottom:'14px', fontFamily:F, letterSpacing:'-0.01em' }}>{c.name}</div>
                          {c.strengths?.length > 0 && (
                            <div style={{ marginBottom:'12px' }}>
                              <div style={{ fontSize:'9px', fontWeight:700, color:'#22C55E', textTransform:'uppercase', letterSpacing:'0.07em', marginBottom:'6px', fontFamily:F }}>Strengths</div>
                          ...
                          {c.weaknesses?.length > 0 && (
                            <div style={{ marginBottom:'12px' }}>
                              <div style={{ fontSize:'9px', fontWeight:700, color:'#EF4444', textTransform:'uppercase', letterSpacing:'0.07em', marginBottom:'6px', fontFamily:F }}>Weaknesses</div>
                ...
                <div>
                  <button onClick={generateComp} style={{ display:'flex', alignItems:'center', gap:'6px', padding:'7px 14px', fontSize:'12px', fontWeight:500, background:'transparent', border:'1px solid rgba(255,255,255,0.10)', color:'rgba(255,255,255,0.40)', borderRadius:'8px', cursor:'pointer', fontFamily:F, transition:'all 0.15s' }}
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor='rgba(255,255,255,0.22)'; (e.currentTarget as HTMLElement).style.color='rgba(255,255,255,0.70)' }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor='rgba(255,255,255,0.10)'; (e.currentTarget as HTMLElement).style.color='rgba(255,255,255,0.40)' }}>
